...
configuration of the `JobRepository` is handled via the <<java.adoc#javaConfig,`BatchConfigurer`>>.
...
----
 /**
  * All injected dependcies for this bean are provided by the @EnableBatchProcessing
