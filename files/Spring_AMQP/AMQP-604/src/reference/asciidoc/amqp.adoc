...
Only DIRECT, FANOUT and TOPIC exchange types are supported with this mechanism; in addition, queue arguments cannot
be specified.
Use normal `@Bean` definitions for other exchange types, and when more advanced configuration is required.
