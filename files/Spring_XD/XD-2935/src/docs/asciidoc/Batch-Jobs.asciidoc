...
The intention is to eventually support all features of the Sqoop tool including running Sqoop jobs saved in the Sqoop metastore. See http://sqoop.apache.org/docs/1.4.5/SqoopUserGuide.html[Sqoop User Guide] for full documentation of the Sqoop features.
