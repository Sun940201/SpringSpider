...
// Not relying on application.yml to configure the admin, so that modules running via LocalModuleDeployer don't "see" it
@PropertySource("classpath:/META-INF/spring-cloud-data-admin/admin.properties")
